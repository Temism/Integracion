...
public class RegistroClienteDTO {
    ...
    public RegistroClienteDTO(String nombre, String apellidop, String apellidom, String email, String password, String direccion, String telefono, LocalDate fechaNacimiento, LocalDate fechaRegistro, String rut, Long comuna, Long rol) {
        this.nombre = nombre;
